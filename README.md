...
The Axiom server runs the production build under PM2 on LAN port `8091`:
...
Shop-floor PCs can open `http://192.168.148.145:8091/`. The shared tool library is stored outside the
